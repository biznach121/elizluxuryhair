...
export async function generateStaticParams() {
  const r = await getStoreServerClient().catalogue.getCollections();
    ...
    <>
      <section className="bg-foreground text-background relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 py-12 sm:py-14">
          <nav className="text-[12px] font-mono text-background/60 mb-3 flex flex-wrap items-center gap-x-2 gap-y-1 min-w-0">
