...
export default function ContactPage() {
  ...
  return (
    <article className="max-w-5xl mx-auto px-6 sm:px-8 py-10 sm:py-16">
      ...
      <p className="text-lg text-muted-foreground max-w-2xl mb-8 sm:mb-12 leading-relaxed">{c.body}</p>
